...
{
    public static final double CG_FULL_BACK     = 0.80;
    public static final double CG_HALF_BACK     = 1.75;
    public static final double CG_CENTER        = 2.5;
    public static final double CG_HALF_FORWARD  = 3.15;
    public static final double CG_FULL_FORWARD  = 3.75;
    ...
    public BodyPIDSubsystem()
    {
        ...
        super("BodyPIDSubsystem", 0.4, 0.05, 0.0);
